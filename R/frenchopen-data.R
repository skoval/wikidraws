#' French Open Singles Draws
#'
#' Data of results of men's and women's singles draws for all French Open events, pre- and post- Open Era.
#'
#' @docType data
#'
#' @usage data(frenchopen)
#'
...
#'   \item{player}{Character name of player as listed on Wikipedia. This may not be consistent within or between events. See \code{\link{frenchopen_players}}}
