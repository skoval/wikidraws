#' Wimbeldon Singles Draws
#'
#' Data of results of men's and women's singles draws for all Wimbledon events, pre- and post- Open Era.
#'
#' @docType data
#'
...
#'   \item{player}{Character name of player as listed on Wikipedia. This may not be consistent within or between events. See \code{\link{wimbledon_players}}}
